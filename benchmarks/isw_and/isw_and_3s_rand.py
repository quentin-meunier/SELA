...
def isw_and_3s_norand(m0, m1, m2, m3, z12, z13, z23, r0, r1, r2, r3, r4, r5, k0, k1):
    ...
    # a1b2 (r0)
    a1r0 = a1 ^ r0
    a1r0 = mySimplify(a1r0)
    signals.append(a1r0)

    r0b2 = r0 & b2
    r0b2 = mySimplify(r0b2)
    signals.append(r0b2)

    a1r0b2 = a1r0 & b2
    a1r0b2 = mySimplify(a1r0b2)
    ...
    # a1b3 (r1)
    a1r1 = a1 ^ r1
    a1r1 = mySimplify(a1r1)
    signals.append(a1r1)

    r1b3 = r1 & b3
    r1b3 = mySimplify(r1b3)
    signals.append(r1b3)

    a1r1b3 = a1r1 & b3
    a1r1b3 = mySimplify(a1r1b3)
    ...
    # a2b1 (r2)
    a2r2 = a2 ^ r2
    a2r2 = mySimplify(a2r2)
    signals.append(a2r2)

    r2b1 = r2 & b1
    r2b1 = mySimplify(r2b1)
    signals.append(r2b1)

    a2r2b1 = a2r2 & b1
    a2r2b1 = mySimplify(a2r2b1)
    ...
    # a2b3 (r3)
    a2r3 = a2 ^ r3
    a2r3 = mySimplify(a2r3)
    signals.append(a2r3)

    r3b3 = r3 & b3
    r3b3 = mySimplify(r3b3)
    signals.append(r3b3)

    a2r3b3 = a2r3 & b3
    a2r3b3 = mySimplify(a2r3b3)
    ...
    # a3b1 (r4)
    a3r4 = a3 ^ r4
    a3r4 = mySimplify(a3r4)
    signals.append(a3r4)

    r4b1 = r4 & b1
    r4b1 = mySimplify(r4b1)
    signals.append(r4b1)

    a3r4b1 = a3r4 & b1
    a3r4b1 = mySimplify(a3r4b1)
    ...
    # a3b2 (r5)
    a3r5 = a3 ^ r5
    a3r5 = mySimplify(a3r5)
    signals.append(a3r5)

    r5b2 = r5 & b2
    r5b2 = mySimplify(r5b2)
    signals.append(r5b2)

    a3r5b2 = a3r5 & b2
    a3r5b2 = mySimplify(a3r5b2)
